            ...
            <div className="bg-slate-100 rounded-md shadow-md my-16 mx-36 px-8 py-4">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="form-control w-full">
                        ...
                        <input {...register("name", { required: true })} type="text" placeholder="Type Recipe Name..." className="input input-bordered w-full" />
                    </div>
                    <div className="flex gap-8 mt-2">
                        ...
                        <div className="form-control w-full">
                            ...
                            <input {...register("price", { required: true })} type="text" placeholder="Type Price..." className="input input-bordered w-full" />
                        </div>
                    </div>
                    {/* Recipe Details */}
                    <div className="form-control w-full mt-2">
                        ...
                        <textarea  {...register("recipe")} placeholder="Recipe Details..." className="textarea textarea-bordered textarea-md w-full" ></textarea>
                    </div>
                    <div className="mt-4">
                        <input {...register("image", { required: true })} type="file" className="file-input file-input-bordered w-full max-w-xs" />
                    </div>
                    <div>
                        <button className="btn bg-amber-600 mt-5 text-white hover:bg-amber-700">add item <FaUtensils></FaUtensils></button>
                    </div>
                </form>
            </div>
        </div>
